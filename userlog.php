...
<div class="frm" >
<form  action = "includes/userlog2.php" method = "POST" name="myForm" onsubmit="return validateForm()">
<label for="ha" class="label">Email:<input id="ha" type="text" name="email" placeholder="email"><br />

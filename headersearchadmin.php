...
<body>
    <div class="container">
        <nav class="navbar nav-tabs navbar-expand-lg bg-dark text-light">
            <a class="navbar-brand" href="adminpage.php">Car Galleria Kenya</a>
                    ...
                    <a class="nav-link" href="appointadmin.php">Appointment <span class="sr-only">(current)</span></a>
                </li>
                    <a class="nav-link" href="carsadmin.php">Cars Sold <span class="sr-only">(current)</span></a>
                </li>

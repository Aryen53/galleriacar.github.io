...
$setResult = "SELECT sub_model_id, model, body_style, engine, engine_disp FROM submodel WHERE sub_model_id OR model LIKE '%$model%'";
$result = mysqli_query($conn, $setResult);

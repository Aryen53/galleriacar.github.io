    ...
    <div class="container">
        <nav class="navbar nav-tabs navbar-expand-lg bg-dark text-light">
            <a class="navbar-brand" href="carsellers.php">Galleria</a>
                    ...
                    <a class="nav-link" href="contactadminseller.php">Contact <span class="sr-only">(current)</span></a>
               
                    <a class="nav-link" href="userlogout.php">Logout <span class="sr-only">(current)</span></a>
                
            </ul>
            <form class="form-inline my-2 my-lg-0" action="searchseller2.php" method="POST"  name="myForm" onsubmit="return validateForm()">

...
<?php
	...
	echo '<p class="form-text text-danger"> Login successful !</p>';
			...
			?>
<form  action = "includes/userlog2.php" method = "POST" name="myForm" >
<!--onsubmit="return validateForm()"-->
	...
	?>
                <div>
                 <input class="form-control" id="hf" type="password" name="password" placeholder="Enter password" min='8'>
                </div><br />
				Or don't you have an account? <a href="usersignup.php">Signup Here</a><br /><br />
				<a href="userforgot.php">Forgot Password?</a><br /><br />

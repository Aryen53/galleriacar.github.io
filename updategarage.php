...
<?php
	...
	echo '<p class="form-text text-danger"> Signup successful !</p>';
			...
			?>
<form  action = "includes/garageupdate.php" method = "POST" name="myForm">
 ...
 <?php
	...
	?>
			...
			<input class="form-control" id="ha" type="text" name="last" placeholder="Last Name"><br />
                    <span class="Error"></span>
					<!--<small  class="form-text text-danger">Use the previous Username</small>
			<input class="form-control" id="ha" type="text" name="username" placeholder="Username"><br />
				...
				<input class="form-control" id="ha" type="text" name="gname" placeholder="Garage Name"><br />
                    <span class="Error"></span>
                 <input class="form-control" id="ha" type="text" name="location" placeholder="Location"><br />
                    <span class="Error"></span>
                   <input class="form-control" id="ha" type="text" name="services" placeholder="Services offered"><br />
                    <span class="Error"></span>
                </div>

...
<body>
    <div class="container">
        <nav class="navbar nav-tabs navbar-expand-lg bg-dark text-light">
                    ...
                    <a class="nav-link" href="appoint.php">Appoint <span class="sr-only">(current)</span></a>
                </li>
                    <a class="nav-link" href="carsold.php">Cars<span class="sr-only">(current)</span></a>
                </li>
            ...
            <form  class="form-inline my-2 my-lg-0" action="searchuser.php" method="POST" name="myForm" onsubmit="return validateForm()"
>
			...
			<div id="mySidenav" class="sidenav"><a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
				<br />
				<br />
				            <a class="navbar-brand" href="userpage.php">Galleria </a>
...
while ($rowImg = mysqli_fetch_assoc($resultImg)){
	...
	if($rowImg['status'] == 0){
	echo "<img src='uploads/Galleryuser/profile".$id.".jpg?'".mt_rand()."'>";
	}else {
...
?>
<form class="frm" action="includes/mach.php" method="POST" enctype="multipart/form-data" >
<input type="file" name="file">
<button type="submit" name="submit">UPLOAD PROFILE</button>
	</form><br />
	<form class='frm' action='includes/machdelete.php' method='POST'>
